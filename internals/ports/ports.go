...
import (
	...
	"github.com/Pr3c10us/absolutego/internals/ports/queue"
...
func NewPorts(adapters *adapters.Adapters, services *services.Services, environment *configs.EnvironmentVariables) *Ports {
	return &Ports{
		...
		AMQConsumer: queue.NewAMQConsumer(environment, adapters.Dependencies.AMQP, services, adapters),
	}
}
